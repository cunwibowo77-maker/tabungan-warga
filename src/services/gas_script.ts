 ...
 *   Mulai dari baris "/** MASTER GOOGLE APPS SCRIPT BACKEND ENDPOINT ..." 
...
function getSheetData(ss, sheetName) {
  ...
  for (let r = 1; r < values.length; r++) {
    ...
    if (!isEmptyRow) {
      ...
      if (obj.terkumpul !== undefined) obj.terkumpul = Number(obj.terkumpul) || 12500000; // Let's set default or dynamic
